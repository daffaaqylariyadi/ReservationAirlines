 ...
 * @author febri
 */
public class FormMainUser extends javax.swing.JFrame {
...
private void resetPanelStatus() {
    ...
    private void initComponents() {
        ...
        lb_flight.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/schedule.png"))); // NOI18N
        ...
        pn_flightLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pn_flightLayout.createSequentialGroup()
        ...
        pn_flightLayout.setVerticalGroup(
            ...
            .addGroup(pn_flightLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lb_flight, javax.swing.GroupLayout.DEFAULT_SIZE, 30, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        pn_dasboardLayout.setVerticalGroup(
            pn_dasboardLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lb_dasboard, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 30, Short.MAX_VALUE)
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormMainUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormMainUser().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel lb_flight;
    ...
    private javax.swing.JPanel pn_flight;
    private javax.swing.JPanel pn_ticket;
